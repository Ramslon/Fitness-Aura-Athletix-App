...
class BackWorkouts extends StatelessWidget {
	...
	static final List<_Exercise> _exercises = [
		_Exercise(
			...
			description: 'Barbell bent-over rows build thickness across the middle back.',
		...
		_Exercise(
			id: 'dumbbell_rows',
			title: 'Dumbbell Rows',
			description: 'Single-arm dumbbell rows for unilateral strength and balance.',
		...
		_Exercise(
			id: 'deadlift',
			title: 'Deadlift',
			description: 'Deadlifts load the entire posterior chain and build overall strength.',
		...
		_Exercise(
			...
			description: 'Seated rows emphasize the mid-back and scapular retraction.',
					...
					itemBuilder: (context, index) {
						...
						return GestureDetector(
							onTap: () => Navigator.push(
								context,
								MaterialPageRoute(builder: (_) => BackExerciseDetail(exercise: ex)),
							),
							child: Card(
...
class BackExerciseDetail extends StatelessWidget {
	...
	const BackExerciseDetail({Key? key, required this.exercise}) : super(key: key);
