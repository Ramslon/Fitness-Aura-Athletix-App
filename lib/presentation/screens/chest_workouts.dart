...
class ChestWorkouts extends StatelessWidget {
	...
	static final List<_Exercise> _exercises = [
		_Exercise(
			...
			description: 'Barbell flat bench press — compound pressing movement for overall chest strength.',
		...
		_Exercise(
			...
			description: 'Dumbbell flies isolate the chest and create stretch at the bottom of the movement.',
		...
		_Exercise(
			id: 'pullovers',
			title: 'Pullovers',
			description: 'Dumbbell pullovers work the chest and lats depending on arm path.',
		...
		_Exercise(
			id: 'dips',
			title: 'Dips',
			description: 'Parallel-bar dips (lean forward) emphasize the lower chest and triceps.',
		...
		_Exercise(
			...
			description: 'Dumbbell press allows a greater range of motion and balanced loading.',
